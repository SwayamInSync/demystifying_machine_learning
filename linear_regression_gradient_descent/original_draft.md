...
Before moving on to next section and discuss about Regularization, I want to demostrate how we can also fit curves instead of straight line to a dataset, let's see it in the next sub-section.
